...
Friendship.create!({requester_id: User.find_by(email: "random2@gmail.com").id, requestee_id: User.find_by(email: "random8@gmail.com").id, accepted: false})
Friendship.create!({requester_id: User.find_by(email: "random2@gmail.com").id, requestee_id: User.find_by(email: "random9@gmail.com").id, accepted: false})
Friendship.create!({requester_id: User.find_by(email: "random3@gmail.com").id, requestee_id: User.find_by(email: "random4@gmail.com").id, accepted: false})
