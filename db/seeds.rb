...
User.create!({ email: "random@gmail.com", password: "random", full_name: "Christopher", last_name: "Johnson", birth_date: "12/11/1996", gender: "male", school: "Donnelly College", location: "Kansas City, MO", written_bio: "https://qph.fs.quoracdn.net/main-qimg-158c90908c0663d81e5cdec64de5bc96" });
User.create!({ email: "random2@gmail.com", password: "random", full_name: "Randy", last_name: "Davis", birth_date: "11/14/1990", gender: "male", school: "University of North Carolina at Chapel Hill", location: "Boston, MA", written_bio: "https://miro.medium.com/max/5680/1*auyELWA7GkYHF-h2YoX-Uw.jpeg" });
User.create!({ email: "random3@gmail.com", password: "random", full_name: "Erica", last_name: "Harper", birth_date: "10/20/1994", gender: "female", school: "New York University", location: "New York, NY", written_bio: "https://blueprint-api-production.s3.amazonaws.com/uploads/card/image/846105/6cfa8ca4-3696-4212-a054-3db90589852c.jpg" });
...
User.create!({ email: "random5@gmail.com", password: "random", full_name: "Eric", last_name: "Andre", birth_date: "10/20/1991", gender: "male", school: "Berklee College of Music", location: "Boca Raton, FL", written_bio: "https://globalnews.ca/wp-content/uploads/2019/04/gettyimages-631597174.jpg?quality=85&strip=all&w=1200" });
User.create!({ email: "random6@gmail.com", password: "random", full_name: "Jessica", last_name: "Thomas", birth_date: "10/20/1995", gender: "female", written_bio: "https://media.vanityfair.com/photos/5f7736a15b33964912365df5/master/pass/jessica.jpg", school: "Columbia University", location: "New York, NY" });
User.create!({ email: "random7@gmail.com", password: "random", full_name: "Rick", last_name: "Sanchez", birth_date: "11/29/1955", gender: "male", written_bio: "https://pbs.twimg.com/profile_images/936048451430760448/nvBks8aj_400x400.jpg", school: "Ohio State University", location: "Columbus, OH" });
User.create!({ email: "random8@gmail.com", password: "random", full_name: "Marisa", last_name: "Mali", birth_date: "12/20/1997", gender: "female", written_bio: "", location: "Los Angeles, CA", school: "Sierra Nevada Prepatory" });
User.create!({ email: "random9@gmail.com", password: "random", full_name: "James", last_name: "Dean", birth_date: "10/20/1998", gender: "male", written_bio: "https://images.findagrave.com/photos250/photos/2005/39/267_110799478308.jpg", school: "Princeton University", location: "Honolulu, HI" });
